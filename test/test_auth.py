...
admin_identity = sdk.wallet_manager.create_identity_from_private_key("sss", "111111", '75de8489fcb2dcaf2ef3cd607feffde18789de7da129b5e97c81e001793cb7cf')

new_admin_identity = sdk.wallet_manager.create_identity_from_private_key("sss2", "111111", '1383ed1fe570b6673351f1a30a66b21204918ef8f673e864769fa2a653401114')

identity = sdk.wallet_manager.create_identity_from_private_key("sss2", "111111", '523c5fcf74823831756f0bcb3634234f10b3beb1c05595058534577752ad2d9f')
...
class TestAuth(unittest.TestCase):
    ...
    def test_register(self):
        ...
        txhash = sdk.rpc.send_raw_transaction(tx)
        txhash2 = sdk.rpc.send_raw_transaction(tx2)
        time.sleep(6)
        print(sdk.rpc.get_smart_contract_event_by_tx_hash(txhash))
        print(sdk.rpc.get_smart_contract_event_by_tx_hash(txhash2))
    ...
    def test_init(self):
        ...
        res = sdk.neo_vm().send_transaction(contract_address, acc, acc, 20000, 0, func, False)
        time.sleep(6)
